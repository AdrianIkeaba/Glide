...
public final class SendMsgBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static SendMsgBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static SendMsgBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.send_msg, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SendMsgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SendMsgBinding((LinearLayout) rootView, audioLayout, audioLength, hLinear, image,
          imageCard, mLinear, play, sendMessage, time);
    }
