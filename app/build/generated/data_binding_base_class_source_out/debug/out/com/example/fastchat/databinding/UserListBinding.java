...
public final class UserListBinding implements ViewBinding {
  ...
  private UserListBinding(@NonNull ConstraintLayout rootView, @NonNull TextView message,
      @NonNull ImageView profile, @NonNull TextView userName) {
  ...
  public static UserListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserListBinding((ConstraintLayout) rootView, message, profile, userName);
    }
